...
<body style="background-color: #EBF4F6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: 'get_events.php?lab=lab3',
        ...
        document.getElementById('addScheduleBtn').addEventListener('click', function () {
            Swal.fire({
                ...
                html:
                    ...
                    '<input type="hidden" id="swal-lab" value="lab3">' +
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: 'check_conflicts.php?lab=lab3',
                        type: 'POST',
                        data: scheduleData,
                        dataType: 'json',
    ...
    <script>
        document.getElementById('printScheduleBtn').addEventListener('click', function () {
            const title = encodeURIComponent("Computer Laboratory 3 Schedule");
            const lab = "lab3";
